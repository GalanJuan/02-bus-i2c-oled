...
void runSystemPOST() {
    ...
    // TODO 4.1: Mostrar la cabecera visual invocando 
    showBootHeader()
    ...
    // TODO 4.3: Concluir la rutina mostrando la barra final con 
    showSystemReady()
...
if (total > 0 && initDisplay()) {
    ...
    Serial.println("[ERROR] Fallo crítico en el arranque. Revisa conexiones I2");
    }
}
